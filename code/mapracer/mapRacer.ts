...
//generic typescript import for jQuery 
declare var $:any;

//import the three other map racer modules 
import Car = require("./carController");
import MapController = require("./mapController");
import Route = require("./routeEngine");

/** 
 * THIS IS THE MAIN MAP RACER CLASS THAT ORCHESTRATES THE GAME LOGIC
 * IT IS INSTANTIATED AS A SINGLETON OBJECT
 **/
export class MapRacer {
    private static _instance:MapRacer = new MapRacer(); 
    private _speed: Car.Speed; // Singleton object that manages the car's speed
    private _steering: Car.Steering; // Singleton object that manages the car's steering
    private _mapController: MapController.MapController; // Singleton object that creates and manages the scene view
    private _routeEngine: Route.RouteEngine; // Singleton object that manages the car's interaction with the route
    private _leaderboardUrl: String; // The leaderboard feature service's endpoint URL
    ...
    public static getInstance():MapRacer{
